...
<script>
   ...
   $.validator.addMethod(        
    ...
    function setTotal(){  
        $("#total").html((parseInt(t.val())*${sessionScope.Book.unitPrice}).toFixed(2));  
    }  
    setTotal();
    })  
</script>
    ...
    <div class="body">
        ...
        <div class="content">
             ...
             <h4>${sessionScope.Book.title}</h4>
				...
				<form action="">
                       <input type="text"  value="1"  id="goodsNum"  name="text"  class="text"/>
                       <div class="btn">
                       <input type="button"  value="+"  id="add"  name="btn"  class="btn1"/>
                       <input type="button"  value="-"  id="min"  name="btn"  class="btn2"/>
                       </div>
	    			   <input class="submit" type="submit" value="加入购物车"></input>
	    			   当前总价：<label id="total" style="color: red;"></label>
				</form>
        </div>
        </div>
        </div>
